...
<body>
  ...
  <div class="admin-content">
    ...
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">报表</strong> / <small></small>入库报表</div>
    </div>
          ...
          <table id="table" class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                ...
                <th class="table-type">入库量</th>
              </tr>
          </thead>
          <tbody>
            <c:forEach items="${warehousingInfo}" var="list">
            	<tr>

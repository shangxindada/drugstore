	...
	<div class="am-g">
      <div class="am-u-sm-12">
        <form class="am-form">
          ...
          <tbody>
            <c:forEach items="${drugInfo.list}" var="list">
            	<tr>
        ...
        <ul class="am-pagination">
		  <li  class="${ drugInfo.pageNum == 1 ? 'am-disabled' : ''}"><a href="selectDrugInfoAll?pageNum=${drugInfo.pageNum -1}">&laquo;</a></li>
		  <c:forEach begin="1" end="${drugInfo.pages}" var="page">
		  <li class="${ drugInfo.pageNum == page ? 'am-active' : ''}"><a href="selectDrugInfoAll?pageNum=${page}">${page}</a></li>
			</c:forEach>
		  <li class="${ drugInfo.pageNum == drugInfo.pages ? 'am-disabled' : ''}"><a href="selectDrugInfoAll?pageNum=${drugInfo.pageNum + 1}">&raquo;</a></li>
		</ul>
		          <hr />
          <p>注：这里是对商品信息的维护！</p>
        </form>
